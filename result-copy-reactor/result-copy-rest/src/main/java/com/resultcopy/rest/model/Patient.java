...
public class Patient {
  ...
  private List<PatientDetails> patientDetails = null;

  public Patient patientDetails(List<PatientDetails> patientDetails) {
  ...
  public Patient addPatientDetailsItem(PatientDetails patientDetailsItem) {
    if (this.patientDetails == null) {
      this.patientDetails = new ArrayList<PatientDetails>();
    }
